...
/**
 * This interface implements the Strategy design pattern, used for virtual players to adopt different behaviours.
 * @see JoueurVirt,Facile,Difficile
 * @author dinh_, tran_
 *
 */
public interface Strategie {
	 ...
	 * @param listCarte the cards available for the offer, often in the hands of the player
