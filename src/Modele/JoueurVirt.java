...
/**
 * This class inherits from Joueur and is the main user of the Strategy design
 * pattern. This class has redefined methods from its superclass.
 * 
 * @author dinh_, tran_
 *
 */
public class JoueurVirt extends Joueur {
	...
	/**
	 * This constructor initialise the attributes inherited from its superclass.
	 * Creates a jest and a hand at the same time. It also defines the strategy to
	 * use.
	 * 
	...
	public void faireOffre() {
		int temp = strat.faireOffre(this.main.getCarteTas());
