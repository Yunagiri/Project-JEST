...
/**
 * This class is a Visitor designed to calculate player's jest scores. It
 * contains methods that uses the value of each card in the player's jest in
...
public class CompteurDeScore1 implements Visitor {
	...
	/**
	 * The constructor of this class, initialise the score to 0 for each time it is
	 * called to calculate a jest's score.
	 */
	...
	/**
	 * This method contains all the elements to calculate the score of Spade, Club
	 * and Diamond suit cards. If the card suit is a Spade or a Club, the score of
	 * the jest increases of the face value of the card. If the card suit is
	 * Diamond, it decreases the score of the jest of the face value of the card.
	 * 
	...
	/**
	 * This method calculates the score Heart cards gives. The Heart score is
	 * dictated by the rules of the game:
	 * <ul>
	 * <li>If the jest has a joker and no Hearts, increases the score by 4.
	 * <li>If the jest has a joker and 3 Hearts or less, decreases the score by the
	 * total face value of all the Hearts.
	 * <li>If the jest has a joker and all Hearts, increases the score by the total
	...
	/**
	 * This method determines whether an Ace is worth 1 or 5 points, depending on
	 * the number of cards of the same suit in the jest.
	 * 
	 * @param j The Jest which needs scoring
	 */
	...
	/**
	 * The method that implements the Visitor interface. Call all the methods
	 * defined above and return the score of the Jest visited.
	 * 
	 * @param j the Jest which needs scoring.
	 */
