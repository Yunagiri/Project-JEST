...
/**
 * <b>This class defines the different types of cards used in the game, and
 * their possible actions.</b>
 * <p>
...
public class Carte {
	...
	/**
	 * This card's total value, calculated from its suit and face value. Not to be
	 * mistaken as the hauteur. Used to calculate jest's scores. The value is
	...
	/**
	 * This is the constructor for the subclass SuitCards, it is used when creating
	 * a new SuitCard.
	 * 
	 * @param hauteur    the face value of the card
	 * @param faceCachee the state of the card, face-up or face down.
	 * @param condi      indicates the condition that enables the players to take
	 *                   this card as a trophy.
	...
	/**
	 * This is the constructor for the Joker, since it doesn't have a suit, it needs
	 * a constructor that doesn't take suits as a parameter.
	 * 
	 * @param hauteur    the face value of the card
	 * @param faceCachee the state of the card, face-up or face-down
	 * @param condi      the condition that enables players to take this card as a
	 *                   trophy
	 */
	...
	/**
	 * This method shows the card's name e.g "1 de Coeur" and it's value on a
	 * console command line.
	 * 
	 * @return a line on the console command, either the card is face down and you
	 *         can't see it, or it's face up and will return its characteristics.
	 */
